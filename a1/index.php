...
<link type="text/css" rel="stylesheet" href="<?php echo URL_ROOT //moved link name out of php tag to read easier?>styles.css" />
</head>
...
<div id="wrapper">
	...
	<form action=add_products_to_inventory.php method="post">
		<!-- ***** removed the url root because a url link is not needed here *****-->
	...
	// ***** Took out ) added a bracket to close it *****
	?>
